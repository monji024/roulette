...
## یه نکته درباره‌ی حد و مرزها

این پروژه عمداً هیچ نوع تشخیص ماشین مجازی یا سندباکس رو پیاده‌سازی
نکرده. تغییر دادن مخفیانه‌ی رفتار -یا خارج شدن- وقتی یه محیط آنالیز
تشخیص داده می‌شه، امضای کلاسیک بدافزارهاست، و این پروژه این کار رو
انجام نمی‌ده، حتی اگه به شکل یه شوخی تو بازی باشه. قانون شماره‌ی ۲ بالا
یه شرط بازیه، نه یه مکانیزم فنی برای اجباری کردنش.
